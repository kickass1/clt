...
static const int64 MAX_MONEY = 25000000 * COIN; // CryptoLottoToken: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 1.5) / 250; // CryptoLottoToken: Priority cutoff is 2 CryptoLottoToken day / 250 bytes.
    }
